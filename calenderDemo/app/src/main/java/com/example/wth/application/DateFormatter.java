...
public class DateFormatter {
    ...
    private String getArrayString(int id, int index) {
    ...
    public CharSequence getDayName(LunarCalendar lc) {
        ...
        if (day < 11) {
            ...
            result.append(getArrayString(R.array.digital, day));
        } else if (day < 20) {
            result.append(getArrayString(R.array.chinesePrefix, 1));
            result.append(getArrayString(R.array.digital, day - 10));
        } else if (day == 20) {
            result.append(getArrayString(R.array.digital, 2));
            result.append(getArrayString(R.array.digital, 10));
        } else if (day < 30) {
            result.append(getArrayString(R.array.chinesePrefix, 2));
            result.append(getArrayString(R.array.digital, day - 20));
        } else {
            result.append(getArrayString(R.array.digital, 3));
            result.append(getArrayString(R.array.digital, 10));
        }
    ...
    public CharSequence getMonthName(LunarCalendar lc) {
        ...
        switch (month) {
            ...
            case 12:
                ...
                break;
            default:
                result.append(getArrayString(R.array.digital, month));
                break;
        }
        result.append(getArrayString(R.array.time, 1));
        return result;
    }
    ...
    public CharSequence getYearName(LunarCalendar lc) {
        ...
        result.append(getArrayString(R.array.time, 0));
